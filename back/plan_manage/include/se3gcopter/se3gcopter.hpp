...
private:
                                  ...
                                  Eigen::MatrixXd &gdC) 
    {
        ...
        // std::cout<<"cpu: "<<cost<<" gpu: "<<cost1<<" init: " <<cost0<<endl;
        ...
        // std::cout<<"gradT: \n"<<gdT1<<endl;
        // std::cout<<"gradC: \n"<<gdC1<<endl;
        // std::cout<<"cost: "<<cost1<<endl;
        

        // ROS_WARN("iter: %d cost: %f, cost1: %f,cost0: %f",a,cost,cost1,cost0);
        // ROS_INFO_STREAM("cpu gdC: "<<gdC.row(56));
        // ROS_INFO_STREAM("gpu gdC: "<<gdC1.row(56));
        // ROS_INFO_STREAM("gpu time: "<<(double)(t_1-t_0)/CLOCKS_PER_SEC<<" cpu time: "<<(double)(t_2-t_1)/CLOCKS_PER_SEC);
        // ROS_INFO_STREAM("initial: "<<t0<<" dev: "<<t1
        // <<" compu: "<<t2<<" host: "<<t3<<" output: "<<t4
        // );
...
public:
    ...
    inline bool setup(const double &rh,
                      ...
                      bool c2diffeo,double budget=100000.0)
    {
        ...
        //
        //hzcmy load param
        // jerkOpt.pena_param.segs = fineN;
        // jerkOpt.pena_param.b = jerkOpt.
        // jerkOpt.paraller.setup(fineN,cfgHs);
                           ...
                           const double &relCostTol)
    {
        ...
        int stateflag = lbfgs::lbfgs_optimize(dimFreeT + dimFreeP,
                              x,
                              &minObjectivePenalty,
