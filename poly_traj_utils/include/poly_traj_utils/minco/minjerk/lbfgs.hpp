    ...
    else
    {
        ...
        */
        ...
        while (loop == 1)
        {
            ...
            /* If numerical condition is bad, switch to simple but stable line search. */
            if (ls < 0)
            {
                ...
                /* The externally provided bound on step is exceeded, which is unresolved. */
                ls = (cd.proc_stepbound != nullptr && lss == LBFGSERR_MAXIMUMSTEP) ? ls : lss;
            }
